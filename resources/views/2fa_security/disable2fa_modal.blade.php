    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">{{ __('Verify Your Otp') }}</h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-5">
                        {{ Form::text('twoStep_otp', null, ['id'=>'twoStepOTP','class' => 'form-control','required' ,'placeholder' => __('Enter Google Authenticator Code'),'onkeyup'=>'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
                    </div>
                </div>
            </div>
