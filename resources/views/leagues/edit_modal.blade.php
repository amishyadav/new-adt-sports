                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-5">
                        ...
                        {{ Form::select('category_id', $category, '', [
                           ...
                           'data-control'=>'select2','id' => 'editCategoryDropdown']) }}
                    </div>
                    <div class="form-group col-md-12 mb-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control icon" name="icon" id="editLeagueIcon">

                            <div class="input-group-append">
                                <button type="button" class="btn btn-outline-secondary" data-icon="fas fa-home" role="iconpicker" id="editLeagueIconPicker" data-iconset="fontawesome5"><i class="fas fa-home"></i><input type="hidden" value="las la-home"><span class="caret"></span></button>
