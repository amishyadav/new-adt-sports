    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">{{ __('Edit Partner Section') }}</h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['id'=>'editPartnerName','class' => 'form-control','required','placeholder' => __('Name')]) }}
                    </div>
                    <div class="mb-5 form-group col-md-12" io-image-input="true">
                        <label for="exampleInputImage" class="form-label">Image:</label>
                        <div class="d-block">
                            <div class="image-picker">
                                <div class="image previewImage" id="editPartnerImagePreview"
