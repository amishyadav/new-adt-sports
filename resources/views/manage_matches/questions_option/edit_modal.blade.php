            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <label class="form-control-label font-weight-bold">Ratio <span class="text-danger">*</span></label>

                        <div class="input-group">

                            <input type="number" step="0.01" class="form-control" name="dividend" id="editOptionDividend" required="">

                            <span class="input-group-text font-weight-bold rounded-0">:</span>

                            <input type="number" step="0.01" class="form-control" name="divisor" id="editOptionDivisor" required="">
