    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">{{ __('Edit Social Icon') }}</h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-5">
                        ...
                        {{ Form::text('title', null, ['id'=>'editTitle','class' => 'form-control','required' ,'placeholder' => __('Title')]) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('icon', __('Select Icon').(':'), ['class' => 'form-label']) }}
                        <div class="input-group">
                            <input type="text" class="form-control icon" name="icon" id="editSocialIcon">

                            <div class="input-group-append">
                                <button type="button" class="btn btn-outline-secondary" data-icon="fas fa-home" role="iconpicker" id="editSocialIconPicker" data-iconset="fontawesome5"><i class="fas fa-home"></i><input type="hidden" value="las la-home"><span class="caret"></span></button>
