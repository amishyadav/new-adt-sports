        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <div class="mb-3 position-relative">
                        {{Form::password('confirm_password',['class' => 'form-control','placeholder' => __('messages.user.password_confirmation'),'autocomplete' => 'off','required','aria-label'=>"Password",'data-toggle'=>"password"])}}
                        <span class="position-absolute d-flex align-items-center top-0 bottom-0 end-0 me-4 input-icon input-password-hide cursor-pointer text-gray-600"> <i class="fa-solid fa-eye"></i> </span>
                    </div>
                </div>
            </div>
